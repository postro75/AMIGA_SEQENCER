...
ST_DRUM_CANDIDATES: Dict[str, List[str]] = {
    ...
    "CLAP": [
        ...
        "Clap",
        "claps",
        # ST-02 has no dedicated clap — short snare works as layer
        "PopSnare1",
        "Snare9",
        "snare10",
    ],
    ...
    "TOM HI": ["ElecTom", "DxTom", "thetom2", "Perc-Timbale", "Perc-Bongo", "thetom3", "tom"],
    "CRASH": [
        "thecymbal",
        "thecymbal2",
        "Smash1",
    ...
    "COWBELL": ["CowBell", "Cowbell2", "cowbell", "cow", "tincan"],
}
